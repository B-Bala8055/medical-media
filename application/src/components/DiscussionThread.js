        ...
        <div className='mb-2'>
            ...
            <div className="ms-md-4 mb-4">
                ...
                <ul className="list-group">
                    <li className="list-group-item flex-wrap"> <small>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Recusandae, quidem molestiae perspiciatis asperiores porro alias? <span className='text-muted'> &nbsp;Master posted on 25-Aug-2020</span></small>&nbsp;<span class="badge badge-primary bg-secondary">10 VOTES</span><button className="btn btn-link btn-sm">Upvote</button><button className="btn btn-link btn-sm">Downvote</button></li>
                    <li className="list-group-item flex-wrap"> <small>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Recusandae, quidem molestiae perspiciatis asperiores porro alias? <span className='text-muted'> &nbsp;Master posted on 25-Aug-2020</span></small>&nbsp;<span class="badge badge-primary bg-secondary">10 VOTES</span><button className="btn btn-link btn-sm">Upvote</button><button className="btn btn-link btn-sm">Downvote</button></li>
                    <li className="list-group-item flex-wrap"> <small>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Recusandae, quidem molestiae perspiciatis asperiores porro alias? <span className='text-muted'> &nbsp;Master posted on 25-Aug-2020</span></small>&nbsp;<span class="badge badge-primary bg-secondary">10 VOTES</span><button className="btn btn-link btn-sm">Upvote</button><button className="btn btn-link btn-sm">Downvote</button></li>
                    <li className="list-group-item flex-wrap"> <small>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Recusandae, quidem molestiae perspiciatis asperiores porro alias? <span className='text-muted'> &nbsp;Master posted on 25-Aug-2020</span></small>&nbsp;<span class="badge badge-primary bg-secondary">10 VOTES</span><button className="btn btn-link btn-sm">Upvote</button><button className="btn btn-link btn-sm">Downvote</button></li>
                    <li className="list-group-item flex-wrap"> <small>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Recusandae, quidem molestiae perspiciatis asperiores porro alias? <span className='text-muted'> &nbsp;Master posted on 25-Aug-2020</span></small>&nbsp;<span class="badge badge-primary bg-secondary">10 VOTES</span><button className="btn btn-link btn-sm">Upvote</button><button className="btn btn-link btn-sm">Downvote</button></li>
